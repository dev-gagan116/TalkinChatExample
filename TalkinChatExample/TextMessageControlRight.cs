...
{
    public partial class TextMessageControlRight : UserControl
    {
        ...
        public TextMessageControlRight(string key)
        {
            InitializeComponent();
            this.Name = key;
        ...
        public string TextMsg
        {
            ...
            set
            {
                ...
                if (textMsgLbl.Width>panel3.Width)
                {
                    panel3.UIThread(() => this.panel3.Width = textMsgLbl.Width+4);
